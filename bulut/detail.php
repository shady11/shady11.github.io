...
if(isset($_GET['us'])){
    ...
    switch ($us) {
        ...
        case 19:
            ...
            break;
        case 20:
            $title = "Zara Larsson - So Good";
            $desc = "So Good — второй студийний альбом шведской певицы и автора Zara Larsson, и дебютный муждународный.";
            $image = "http://".$_SERVER[HTTP_HOST]."/demo/bulut/img/files/".$us.".jpg";
            $date = "17 март 2017";
            $itunes = "//tools.applemusic.com/embed/v1/album/1201058048?country=us";
            $link = "https://dl.dropbox.com/s/t1edle7e7pfesfv/Zara_Larsson_-_So_Good_2017.rar?dl=0";
            break;
    }
} else {
